...
String _$cartServiceHash() => r'929d26d53bee59a10bde4bbd2fd83360f5bf128d';

/// See also [CartService].
@ProviderFor(CartService)
final cartServiceProvider =
    NotifierProvider<CartService, List<CommandItem>>.internal(
  CartService.new,
...
typedef _$CartService = Notifier<List<CommandItem>>;
