...
/// See also [searchAddress].
class SearchAddressFamily extends Family {
  /// See also [searchAddress].
  ...
  Override overrideWith(
      FutureOr<List<GeocodeAddress>?> Function(SearchAddressRef ref) create) {
    return _$SearchAddressFamilyOverride(this, create);
  }
}

class _$SearchAddressFamilyOverride implements FamilyOverride {
  _$SearchAddressFamilyOverride(this.overriddenFamily, this.create);

  final FutureOr<List<GeocodeAddress>?> Function(SearchAddressRef ref) create;

  @override
  final SearchAddressFamily overriddenFamily;
...
class SearchAddressProvider
  ...
  SearchAddressProvider _copyWith(
    FutureOr<List<GeocodeAddress>?> Function(SearchAddressRef ref) create,
  ) {
    return SearchAddressProvider._internal(
      (ref) => create(ref as SearchAddressRef),
      name: name,
